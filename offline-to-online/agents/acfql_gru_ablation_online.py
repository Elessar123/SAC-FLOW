...
class ACFQLAgent_GRUAblationOnline(flax.struct.PyTreeNode):
    ...
    def online_actor_loss(self, batch, grad_params, rng):
        ...
        # Total loss.
        actor_loss = bc_flow_loss + self.config['alpha'] * distill_loss + self.config['q_alpha']*q_loss
...
def get_config():
    ...
    config = ml_collections.ConfigDict(
        dict(
            agent_name='acfql_gru_ablation_online',  # Agent name.
